...
var DateProfileGenerator = /** @class */ (function () {
    ...
    ------------------------------------------------------------------------------------------------------------------*/
    // Builds a impl with info about what the dates/ranges will be for the "prev" view.
    ...
    // Builds a impl with info about what the dates/ranges will be for the "next" view.
    ...
    // Builds a impl holding dates/ranges for rendering around the given date.
    ...
    // Builds a impl with info about the "current" range, the range that is
...
var FillRenderer = /** @class */ (function () {
    ...
    // Should return wrapping DOM impl
...
var Component = /** @class */ (function (_super) {
    ...
    */
    // Renders the basic impl of the view before any content is rendered
    Component.prototype.renderSkeleton = function () {
        // subclasses should implement
    };
    // Unrenders the basic impl of the view
...
// Given a jQuery element that might represent a dragged FullCalendar event, returns an intermediate data impl
...
Bootstrap4Theme.prototype.classes = {
    ...
    // day grid
    // for left/right border color when border is inset from edges (all-day in agenda view)
    // avoid `table` class b/c don't want margins/padding/impl. only border color.
